...
public class CustomerCancelOrderView extends javax.swing.JFrame {

    Transaction transaction = new Transaction();
    int idTransaction = 0;
    int idCurrentUser = 0;
    public CustomerCancelOrderView(int idTransaction, int idCurrentUser) {
        initComponents();
    ...
    private void buttonConfirmActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonConfirmActionPerformed
        ...
        if (reason.isEmpty() || reason.trim().toLowerCase().equals("reason")){
            ...
            if (option == JOptionPane.NO_OPTION){
                ...
                OrderStatusView orderStatusView  = new OrderStatusView(idCurrentUser);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CustomerCancelOrderView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CustomerCancelOrderView(0,0).setVisible(true);
            }
        });
    }
